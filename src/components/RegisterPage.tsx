  ...
  const handleGoogleRegister = async () => {
    ...
    try {
      if (!isSupabaseConfigured) {
        ...
        setErrorMsg('Google Registration requires Supabase configuration (SUPABASE_URL and SUPABASE_ANON_KEY).');
        return;
      }
      ...
      <div className="w-full max-w-md bg-white rounded-3xl shadow-xl border border-slate-200 overflow-hidden">
        ...
        <div className="p-8 space-y-6">
          ...
          <div className="flex items-center space-x-3 my-2">
            ...
            <span className="text-[10px] font-extrabold text-slate-400 uppercase tracking-wider">Or manual register</span>
            <div className="h-px bg-slate-200 flex-1" />
          </div>
