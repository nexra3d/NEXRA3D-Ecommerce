...
export const INITIAL_ORDERS: Order[] = [
  ...
  {
    id: 'ord-1002',
    orderNumber: 'N3D-542109 26072026',
    userId: 'usr-demo',
    customerName: 'Varun Manurani',
    customerEmail: 'varunmanurani@gmail.com',
    customerPhone: '+91 98765 43210',
    fulfillmentMethod: 'STORE_PICKUP',
    shippingProvider: 'NEXRA Store',
    courierName: 'Pickup from Store',
    items: [
      {
        id: 'oi-2',
        productId: 'prod-nx-pla-pro',
        productTitle: 'NEXRA Precision PLA+ Pro Filament (1kg Spool)',
        productImage: 'https://images.unsplash.com/photo-1615655406736-b37c4fabf923?auto=format&fit=crop&q=80&w=800',
        price: 1899,
        quantity: 1,
        totalPrice: 1899
      }
    ...
    shippingAddress: {
      ...
      type: 'WORK',
      streetAddress: 'NEXRA 3D Experience & Pickup Hub, Plot 484, TNGOs Colony',
    ...
    trackingEvents: [
      {
        status: 'PENDING',
        title: 'Order Confirmed',
        description: 'Payment verified and order acknowledged.',
        timestamp: '2026-07-26 11:00'
      },
      {
        status: 'PROCESSING',
        title: 'Order Processing',
        description: 'Items being prepared at the Gachibowli store counter.',
